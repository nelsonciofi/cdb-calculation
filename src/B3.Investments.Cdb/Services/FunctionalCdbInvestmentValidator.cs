...
public static class FunctionalCdbInvestmentValidator
{
    public static Result<CdbInvestment, ValidationResult> Validate(CdbInvestment? investment)
    {
        ...
        if (res.IsValid) return investment!;
